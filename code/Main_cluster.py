...
G = nx.read_edgelist('C:/Users/ulusan.a/Desktop/RL_rep/RL/data_files/GridNetwork_7.csv',delimiter=',',  nodetype=int, data=(('debris',float),))
#G = nx.read_edgelist('/home/ulusan.a/RL/data_files/GridNetwork_5.csv',delimiter=',',  nodetype=int, data=(('debris',float),))
EdgeList = G.edges()
...
df_node_data = pd.read_csv('C:/Users/ulusan.a/Desktop/RL_rep/RL/data_files/GridNetwork_7_sd.csv', header=None)
#df_node_data = pd.read_csv('/home/ulusan.a/RL/data_files/GridNetwork_5_sd.csv', header=None)
...
for e in range(int(n_episodes)):
    ...
    #50% of the time select the recently added state
    if random.random < 0.5:
        first_state_id = explored_states.pop()
    else:
...
#df_basis.to_csv('/home/ulusan.a/RL/data_files/basis_100kVI_INS5.csv', sep=',')
df_basis.to_csv('C:/Users/ulusan.a/Desktop/RL_rep/RL/data_files/basis_INS7.csv', sep=',')
...
# df_pr.to_csv('C:/Users/ulusan.a/Desktop/RL_rep/RL/data_files/pr_for_INS6.csv', sep=',')
#df_pr.to_csv('/home/ulusan.a/RL/data_files/pr_for_INS5.csv', sep=',')

with open('C:/Users/ulusan.a/Desktop/RL_rep/RL/data_files/state_info_INS7.csv', 'wb') as myfile2:
...
n_states = max(explored_states) + 2
#max([s for s,a in p_sas.keys()])

Q_T = pd.DataFrame(data=0,
                       index=range(n_states),
                       columns=range(n_actions+1),
                       dtype=float)
...
#for _ in range(20):
    ...
    for s,a in p_sas.keys():
            #df_slice = df.query('s== {} & a=={}'.format(s,a))
        added_value = 0
        #iter2 += 1
        for s_p in p_sas[(s,a)].keys():
            reward = float(r_sas[(s,a)][s_p])
            pr = float(p_sas[(s,a)][s_p])
...
Q_Tnext.to_csv('C:/Users/ulusan.a/Desktop/RL_rep/RL/data_files/Q_optimalVI_INS7.csv',sep=',')
